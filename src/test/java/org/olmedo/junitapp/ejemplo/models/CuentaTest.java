...
class CuentaTest {
    ...
    @BeforeEach
        // metodo de ciclo de vida antes
    void initMetodoTest(TestInfo testInfo, TestReporter testReporter) { // Inyecciones de dependencias
    ...
    class CuentaTestNombreSaldo {
        ...
        @Test
        @DisplayName("El saldo, que no sea null, mayor que cero, valor esperando.")
...
//        assertNotEquals(cuenta2, cuenta);
    ...
    class PruebasParametrizadasTest {
        //cuando hacemo test con decimales es mejor pasarlo con String
        ...
        //hay que crear este archivo /data.csv
